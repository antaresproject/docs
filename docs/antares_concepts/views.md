...
<pre><code>Antares\Foo\Http\Handler\FooMainMenu</code></pre>
...
A menu can be ascribed to the pane object and the example is the following:
...
which will render the content declared by the 'handle' method. The effect:
  ...
  ![AT_VIS08](/img/docs/antares_conceps/views/AT_VIS08.png)
